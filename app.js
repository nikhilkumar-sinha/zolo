/*
   Khaliyar Khetihaar (खलियार खेतिहर) - JavaScript Application Logic
...
const HERITAGE_STORIES = {
  litchi: {
    ...
    content: `
      ...
      <p>At Khaliyar Khetihaar, we partner directly with generational growers in orchards like Mushahari and Minapur. Litchis are highly perishable; they are harvested under the cool morning sky before the sun can dry their juices, pre-cooled, and flown to distribution channels within 24 hours of harvest.</p>
    `
  },
  mango: {
  ...
  makhana: {
    ...
    content: `
      ...
      <p>Khaliyar Khetihaar supports the Mithila cooperative societies, ensuring that the farmers who perform this intense manual labor receive fair, direct wages, keeping this ancient, sustainable wetland farming alive.</p>
    `
  }
};
